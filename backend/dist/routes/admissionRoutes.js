...
router.delete("/admin/admissions/:id", admissionController_1.deleteAdmissionEntry);
...
router.delete("/admin/admissions/stale", admissionController_1.deleteStaleAdmissions);
...
router.post("/admin/auto-assign-batch", admissionController_1.autoAssignBatch);
