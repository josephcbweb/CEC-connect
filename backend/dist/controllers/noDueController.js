...
const clearDue = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if ((_a = updatedNoDue.request) === null || _a === void 0 ? void 0 : _a.student) {
            let entityName = "Academic Due";
            if (updatedNoDue.course)
                entityName = updatedNoDue.course.name;
...
const bulkClearDues = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const duesToClear = yield prisma_1.prisma.noDue.findMany({
            where: {
                id: { in: dueIds },
                status: { not: enums_1.NoDueStatus.cleared },
            },
        ...
        const studentNotificationsMap = new Map();
        duesToClear.forEach(due => {
            var _a, _b;
            if ((_a = due.request) === null || _a === void 0 ? void 0 : _a.student) {
                const studentId = due.request.student.id;
                let entityName = "Academic Due";
                if (due.course)
                    entityName = due.course.name;
                else if (due.serviceDepartment)
                    entityName = due.serviceDepartment.name;
                ...
                (_b = studentNotificationsMap.get(studentId)) === null || _b === void 0 ? void 0 : _b.push(entityName);
            }
        });
