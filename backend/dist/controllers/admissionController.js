...
exports.deleteStaleAdmissions = exports.bulkAssignToClass = exports.autoAssignStudentsToClasses = exports.assignStudentToClass = exports.getUpcomingBatches = exports.getClassesForBatch = exports.getApprovedStudentsForAssignment = exports.bulkUpdateStatus = exports.getAdmissionByNumber = exports.submitAdmissionForm = exports.autoAssignBatch = exports.getPublicDepartments = exports.validateStudent = exports.checkAdmissionStatus = exports.createAdmissionWindow = exports.deleteAdmissionWindow = exports.updateAdmissionWindow = exports.getAdmissionWindows = exports.deleteAdmissionEntry = exports.updateAdmissionStatus = exports.getAdmissionById = exports.getStats = exports.getAdmissions = void 0;
...
const getAdmissions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { page = "1", limit = "20", status, program, search, admissionType, departmentId, } = req.query;
        ...
        if (departmentId && departmentId !== "all") {
            where.OR = [
                ...
                { preferredDepartmentId: parseInt(departmentId) },
            ];
        }
        if (search) {
            where.OR = [
...
const getStats = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const [total, pending, approved, rejected, waitlisted, unassignedApproved] = yield Promise.all([
            ...
            prisma_1.prisma.student.count({ where: { status: enums_1.StudentStatus.approved, classId: null } }),
        ]);
        // Program-wise stats
        const btechCount = yield prisma_1.prisma.student.count({
            where: { program: enums_1.Program.BTECH },
        });
        const mtechCount = yield prisma_1.prisma.student.count({
            where: { program: enums_1.Program.MTECH },
        });
...
const generateAdmissionNumber = (departmentId) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateAdmissionStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (status === enums_1.StudentStatus.approved) {
            const student = yield prisma_1.prisma.student.findUnique({
                where: { id: studentId },
            });
            if (!student) {
            ...
            try {
                const admissionNumber = yield generateAdmissionNumber(deptId);
...
const deleteAdmissionEntry = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const studentId = parseInt(id);
...
exports.deleteAdmissionEntry = deleteAdmissionEntry;
...
const createAdmissionWindow = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const departmentsForProgram = yield prisma_1.prisma.department.findMany({
            where: {
        ...
        const result = yield prisma_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const newWindow = yield tx.admissionWindow.create({
                data: {
                    ...
                    description,
                    isOpen: isOpen !== null && isOpen !== void 0 ? isOpen : true,
...
const autoAssignBatch = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const unassignedStudents = yield prisma_1.prisma.student.findMany({
            where: {
                program: program,
                status: "approved",
                classId: null,
        ...
        unassignedStudents.forEach(student => {
            if (!student.preferredDepartmentId)
                return; // Skip if no preference, they must be assigned manually
...
exports.autoAssignBatch = autoAssignBatch;
    ...
    try {
        ...
        const newStudent = yield prisma_1.prisma.student.create({
            data: {
                ...
                // System fields
                program: formData.program,
                admission_type: formData.admissionType === "nri"
                    ? "NRI"
        ...
        if (newStudent.email) {
            (0, mailService_1.sendAdmissionConfirmation)(newStudent.email, newStudent.name, admissionNumber).catch((err) => console.error("Failed to send confirmation email:", err));
        }
        res.status(201).json({
            success: true,
        ...
        if (status === enums_1.StudentStatus.approved) {
            ...
            for (const id of ids) {
                try {
                    ...
                    const admissionNumber = yield generateAdmissionNumber(deptId);
                    // Update
                    const updated = yield prisma_1.prisma.student.update({
                        where: { id: studentId },
                        data: {
...
const deleteStaleAdmissions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.deleteStaleAdmissions = deleteStaleAdmissions;
