...
exports.addDepartmentToBatch = exports.deleteClass = exports.updateClass = exports.createClass = exports.getAvailableAdvisors = exports.getBatchById = exports.getAllBatches = void 0;
...
const getBatchById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const program = (_a = batch.admissionWindow) === null || _a === void 0 ? void 0 : _a.program;
        let availableDepartments = [];
        if (program) {
            const linkedDeptIds = batch.batchDepartments.map(bd => bd.department.id);
            availableDepartments = yield prisma_1.prisma.department.findMany({
                where: {
                    program: program,
        ...
        res.json({
            success: true,
            data: Object.assign(Object.assign({}, batch), { availableDepartments }),
        });
    }
    catch (error) {
 ...
 */
const addDepartmentToBatch = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existing = yield prisma_1.prisma.batchDepartment.findUnique({
            where: {
        ...
        const newBatchDept = yield prisma_1.prisma.batchDepartment.create({
            data: {
                batchId: parseInt(batchId),
                departmentId: parseInt(departmentId),
            },
...
exports.addDepartmentToBatch = addDepartmentToBatch;
