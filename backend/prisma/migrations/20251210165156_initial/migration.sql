-- CreateEnum
CREATE TYPE "CertificateType" AS ENUM ('BONAFIDE', 'COURSE_COMPLETION', 'TRANSFER', 'CHARACTER', 'OTHER');

-- CreateEnum
CREATE TYPE "CertificateStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'GENERATED');
...
CREATE TABLE "fee_structures" (
    ...
    CONSTRAINT "fee_structures_pkey" PRIMARY KEY ("fee_structure_id")
);
...
-- AddForeignKey
ALTER TABLE "fee_details" ADD CONSTRAINT "fee_details_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "students"("student_id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "invoices" ADD CONSTRAINT "invoices_feeStructureId_fkey" FOREIGN KEY ("feeStructureId") REFERENCES "fee_structures"("fee_structure_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "certificates" ADD CONSTRAINT "certificates_approved_by_id_fkey" FOREIGN KEY ("approved_by_id") REFERENCES "users"("user_id") ON DELETE SET NULL ON UPDATE CASCADE;
