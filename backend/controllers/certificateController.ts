...
console.log('Student data:', certificate.student);
      ...
      const certificateData = {
        ...
        dateOfBirth: certificate.student.date_of_birth ? 
          new Date(certificate.student.date_of_birth).toLocaleDateString() : undefined,
      ...
      const template = certificateTemplates[certificate.type as keyof typeof certificateTemplates](certificateData);
